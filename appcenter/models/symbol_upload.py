...
import six
from appcenter.models.symbol_upload_user_info import SymbolUploadUserInfo  # noqa: F401,E501
from appcenter.models.uploaded_symbol_info import UploadedSymbolInfo  # noqa: F401,E501
...
class SymbolUpload(object):
    ...
    swagger_types = {
        ...
        'status': 'str',
        'symbol_type': 'str',
        'symbols_uploaded': 'list[UploadedSymbolInfo]',
        'origin': 'str',
        'file_name': 'str',
        'file_size': 'float',
        'timestamp': 'datetime'
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SymbolUpload, dict):
