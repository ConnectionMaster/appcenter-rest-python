...
import six
from appcenter.models.generic_log import GenericLog  # noqa: F401,E501


class GenericLogContainer(object):
    ...
    def __init__(self, exceeded_max_limit=None, last_received_log_timestamp=None, logs=None):  # noqa: E501
        """GenericLogContainer - a model defined in Swagger"""  # noqa: E501
    ...
    def exceeded_max_limit(self):
        """Gets the exceeded_max_limit of this GenericLogContainer.  # noqa: E501

        indicates if the number of available logs are more than the max allowed return limit(100).  # noqa: E501

        :return: The exceeded_max_limit of this GenericLogContainer.  # noqa: E501
        :rtype: bool
        """
    ...
    def exceeded_max_limit(self, exceeded_max_limit):
        ...
        :param exceeded_max_limit: The exceeded_max_limit of this GenericLogContainer.  # noqa: E501
        :type: bool
        """
    ...
    def last_received_log_timestamp(self):
        """Gets the last_received_log_timestamp of this GenericLogContainer.  # noqa: E501
        ...
        :return: The last_received_log_timestamp of this GenericLogContainer.  # noqa: E501
        :rtype: datetime
        """
    ...
    def last_received_log_timestamp(self, last_received_log_timestamp):
        ...
        :param last_received_log_timestamp: The last_received_log_timestamp of this GenericLogContainer.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def logs(self):
        """Gets the logs of this GenericLogContainer.  # noqa: E501

        the list of logs  # noqa: E501

        :return: The logs of this GenericLogContainer.  # noqa: E501
        :rtype: list[GenericLog]
        """
        return self._logs
    ...
    def logs(self, logs):
        ...
        :param logs: The logs of this GenericLogContainer.  # noqa: E501
        :type: list[GenericLog]
        """
        if logs is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GenericLogContainer, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GenericLogContainer):
            return False
