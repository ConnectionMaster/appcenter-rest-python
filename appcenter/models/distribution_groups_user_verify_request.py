...
import six
from appcenter.models.distribution_group_id_request import DistributionGroupIdRequest  # noqa: F401,E501
...
class DistributionGroupsUserVerifyRequest(object):
    ...
    """
    swagger_types = {
        'distribution_group_ids': 'list[DistributionGroupIdRequest]'
    }
    ...
    def distribution_group_ids(self):
        ...
        :rtype: list[DistributionGroupIdRequest]
        """
    ...
    def distribution_group_ids(self, distribution_group_ids):
        ...
        :type: list[DistributionGroupIdRequest]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DistributionGroupsUserVerifyRequest, dict):
