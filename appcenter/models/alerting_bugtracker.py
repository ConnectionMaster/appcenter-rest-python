...
from appcenter.models.alerting_event_types import AlertingEventTypes  # noqa: F401,E501
...
class AlertingBugtracker(object):
    ...
    swagger_types = {
        ...
        'state': 'str',
        'token_id': 'str',
        'event_types': 'list[AlertingEventTypes]',
        'crash_count_threshold': 'int',
    ...
    def settings(self):
        ...
        :rtype: AlertingBugtrackerSettings
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AlertingBugtracker, dict):
