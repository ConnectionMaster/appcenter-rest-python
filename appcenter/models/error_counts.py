...
import six
from appcenter.models.error_date_time_counts import ErrorDateTimeCounts  # noqa: F401,E501
...
class ErrorCounts(object):
    ...
    swagger_types = {
        'count': 'int',
        'errors': 'list[ErrorDateTimeCounts]'
    }
    ...
    def errors(self):
        ...
        :rtype: list[ErrorDateTimeCounts]
        """
        return self._errors
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ErrorCounts, dict):
