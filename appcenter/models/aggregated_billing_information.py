...
import six
from appcenter.models.billing_information_plans import BillingInformationPlans  # noqa: F401,E501
from appcenter.models.billing_resource_usage import BillingResourceUsage  # noqa: F401,E501
...
class AggregatedBillingInformation(object):
    ...
    swagger_types = {
        ...
        'timestamp': 'str',
        'id': 'str',
        'billing_plans': 'BillingInformationPlans',
    ...
    def azure_subscription_state(self, azure_subscription_state):
        ...
        if azure_subscription_state not in allowed_values:
            raise ValueError(
                "Invalid value for `azure_subscription_state` ({0}), must be one of {1}"  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AggregatedBillingInformation, dict):
