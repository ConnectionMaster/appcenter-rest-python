...
import six
from appcenter.models.export_configuration_result import ExportConfigurationResult  # noqa: F401,E501
...
class ExportConfigurationListResult(object):
    ...
    """
    swagger_types = {
        'values': 'list[ExportConfigurationResult]',
        'total': 'int',
        'next_link': 'str'
    }
    ...
    def values(self):
        ...
        :rtype: list[ExportConfigurationResult]
        """
        return self._values
    ...
    def values(self, values):
        ...
        :type: list[ExportConfigurationResult]
        """
        if values is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ExportConfigurationListResult, dict):
