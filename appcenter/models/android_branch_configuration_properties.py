...
class AndroidBranchConfigurationProperties(object):
    ...
    def __init__(self, gradle_wrapper_path=None, module=None, build_variant=None, run_tests=True, run_lint=None, is_root=None, automatic_signing=None, keystore_password=None, key_alias=None, key_password=None, keystore_filename=None, keystore_encoded=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AndroidBranchConfigurationProperties, dict):
