...
import six
from appcenter.models.ios_app_extension_info import IosAppExtensionInfo  # noqa: F401,E501
from appcenter.models.xcode_scheme import XcodeScheme  # noqa: F401,E501
...
class XcodeSchemeContainer(object):
    ...
    swagger_types = {
        'path': 'str',
        'shared_schemes': 'list[XcodeScheme]',
        'podfile_path': 'str',
        'cartfile_path': 'str',
        'xcode_project_sha': 'str',
        'workspace_project_paths': 'str',
        'app_extension_targets': 'list[IosAppExtensionInfo]'
    }
    ...
    def shared_schemes(self, shared_schemes):
        ...
        :type: list[XcodeScheme]
        """
        if shared_schemes is None:
            raise ValueError("Invalid value for `shared_schemes`, must not be `None`")  # noqa: E501
    ...
    def app_extension_targets(self):
        ...
        :rtype: list[IosAppExtensionInfo]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(XcodeSchemeContainer, dict):
