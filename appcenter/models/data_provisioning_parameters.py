...
class DataProvisioningParameters(object):
    ...
    def resource_region(self, resource_region):
        ...
        if resource_region not in allowed_values:
            raise ValueError(
                "Invalid value for `resource_region` ({0}), must be one of {1}"  # noqa: E501
                .format(resource_region, allowed_values)
            )
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DataProvisioningParameters, dict):
