...
class TestCloudStartTestRunOptions(object):
    ...
    def __init__(self, test_framework=None, device_selection=None, language=None, locale=None, test_series=None, test_parameters=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TestCloudStartTestRunOptions, dict):
