...
class MetricsValuesByApp(dict):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """MetricsValuesByApp - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MetricsValuesByApp, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetricsValuesByApp):
            return False
