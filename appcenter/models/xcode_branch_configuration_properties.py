...
import six
from appcenter.models.provisioning_profile_file import ProvisioningProfileFile  # noqa: F401,E501
...
class XcodeBranchConfigurationProperties(object):
    ...
    swagger_types = {
        ...
        'app_extension_provisioning_profile_files': 'list[ProvisioningProfileFile]',
    ...
    def app_extension_provisioning_profile_files(self):
        ...
        :rtype: list[ProvisioningProfileFile]
        """
    ...
    def app_extension_provisioning_profile_files(self, app_extension_provisioning_profile_files):
        ...
        :type: list[ProvisioningProfileFile]
        """
    ...
    def xcode_version(self):
        ...
        Xcode version used to build. Available versions can be found in \"/xcode_versions\" API. Default is latest stable version, at the time when the configuration is set.  # noqa: E501
    ...
    def force_legacy_build_system(self):
        ...
        Setting this to true forces the build to use Xcode legacy build system. Otherwise, the setting from workspace settings is used. By default new build system is used if workspace setting is not committed to the repository. Only used for iOS React Native app, with Xcode 10.   # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(XcodeBranchConfigurationProperties, dict):
