...
class StepReport(object):
    ...
    def finished_snapshots(self, finished_snapshots):
        ...
        if finished_snapshots is None:
            raise ValueError("Invalid value for `finished_snapshots`, must not be `None`")  # noqa: E501
    ...
    def device_screenshots(self, device_screenshots):
        ...
        if device_screenshots is None:
            raise ValueError("Invalid value for `device_screenshots`, must not be `None`")  # noqa: E501
