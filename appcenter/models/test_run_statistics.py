...
class TestRunStatistics(object):
    ...
    def __init__(self, devices=None, devices_finished=None, devices_failed=None, total=None, passed=None, failed=None, skipped=None, peak_memory=None, total_device_minutes=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TestRunStatistics, dict):
