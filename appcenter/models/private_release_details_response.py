...
class PrivateReleaseDetailsResponse(object):
    ...
    def __init__(self, id=None, status=None, app_name=None, app_display_name=None, version=None, origin=None, short_version=None, release_notes=None, provisioning_profile_name=None, provisioning_profile_type=None, is_provisioning_profile_syncing=None, size=None, min_os=None, device_family=None, android_min_api_level=None, bundle_identifier=None, fingerprint=None, uploaded_at=None, download_url=None, app_icon_url=None, install_url=None, distribution_group_id=None, publishing_status=None, destination_type=None):  # noqa: E501
    ...
    def status(self):
        ...
        OBSOLETE. Will be removed in next version. The availability concept is now replaced with distributed. Any 'available' release will be associated with the default distribution group of an app.</br> The release state.<br> <b>available</b>: The uploaded release has been distributed.<br> <b>unavailable</b>: The uploaded release is not visible to the user. <br>   # noqa: E501
    ...
    @property
    def origin(self):
        """Gets the origin of this PrivateReleaseDetailsResponse.  # noqa: E501

        The release's origin  # noqa: E501

        :return: The origin of this PrivateReleaseDetailsResponse.  # noqa: E501
        :rtype: str
        """
        return self._origin
    ...
    def origin(self, origin):
        ...
        :param origin: The origin of this PrivateReleaseDetailsResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PrivateReleaseDetailsResponse, dict):
