...
class ApiTokenGetUserResponse(object):
    ...
    def token_scope(self, token_scope):
        ...
        if not set(token_scope).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `token_scope` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(token_scope) - set(allowed_values))),  # noqa: E501
    ...
    def user_origin(self, user_origin):
        ...
        if user_origin not in allowed_values:
            raise ValueError(
                "Invalid value for `user_origin` ({0}), must be one of {1}"  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApiTokenGetUserResponse, dict):
