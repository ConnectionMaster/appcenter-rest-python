...
class ReleaseUpdateRequest(object):
    ...
    def __init__(self, distribution_group_name=None, distribution_group_id=None, destination_name=None, destination_id=None, destination_type=None, release_notes=None, mandatory_update=None, destinations=None, build=None, notify_testers=False):  # noqa: E501
    ...
    def destination_name(self):
        ...
        OBSOLETE. Will be removed in future releases - use destinations instead. Name of a destination. The release will be associated with this destination. If the destination doesn't exist a 400 is returned. If both distribution group name and id are passed, the id is taking precedence.   # noqa: E501
    ...
    def destination_id(self):
        ...
        OBSOLETE. Will be removed in future releases - use destinations instead. Id of a destination. The release will be associated with this destination. If the destination doesn't exist a 400 is returned. If both destination name and id are passed, the id is taking precedence.   # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ReleaseUpdateRequest, dict):
