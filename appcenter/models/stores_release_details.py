...
import six
from appcenter.models.stores_basic_details import StoresBasicDetails  # noqa: F401,E501
...
class StoresReleaseDetails(object):
    ...
    swagger_types = {
        ...
        'download_url': 'str',
        'install_url': 'str',
        'distribution_stores': 'list[StoresBasicDetails]'
    }
    ...
    def install_url(self, install_url):
        ...
        if install_url not in allowed_values:
            raise ValueError(
                "Invalid value for `install_url` ({0}), must be one of {1}"  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoresReleaseDetails, dict):
