...
class AlertingBugtrackerSettings(object):
    ...
    discriminator_value_class_map = {
          ...
          'AlertingJiraBugtrackerSettings': 'AlertingJiraBugtrackerSettings',
'AlertingVstsBugtrackerSettings': 'AlertingVstsBugtrackerSettings',
'AlertingGithubBugtrackerSettings': 'AlertingGithubBugtrackerSettings'    }
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AlertingBugtrackerSettings, dict):
